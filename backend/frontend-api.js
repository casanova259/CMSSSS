// ============================================================
// api.js  –  Drop-in replacement for localStorage helpers
// Place this in your src/ folder and import where needed.
// ============================================================
...
export const feesAPI = {
  ...
  delete:       (id) => request(`/fees/${id}`, { method: 'DELETE' }),
...
export const noDueAPI = {
  ...
  updateClearance: (appId, dept, { cleared, clearedBy, remarks }) =>
    request(`/no-due/${appId}/clearance/${dept}`, {
      method: 'PUT',
      body: JSON.stringify({ cleared, clearedBy, remarks }),
    }),
