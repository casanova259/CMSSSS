...
const FeeReceiptGenerator = () => {
  ...
  const generatePDF = () => {
    ...
    doc.setFontSize(10);
    doc.text('Near Puda Colony new grain market, Malout, Punjab - 125104', 105, 28, { align: 'center' });
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 bg-gray-50">
            <div className="bg-white p-8 shadow-lg">
              <div className="text-center border-b-2 border-gray-300 pb-4 mb-6">
                ...
                <p className="text-sm text-gray-600">6F2W+9PQ Shri Muktsar Sahib, New Grain Market, Green Field Enclave, Sarabha Nagar, Malout, Malout Rural, Punjab 152107</p>
              </div>
